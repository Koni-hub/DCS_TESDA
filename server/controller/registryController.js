...
export const saveRegistry = async (req, res) => {
    try {
        ...
        res.status(201).json({msg: "Registry created successfully", RegistryData: createRegirsty});
    } catch (err) {
        res.status(500).json({msg: "Internal Server Error"});
    }
}
...
export const editRegistry = async (req, res) => {
    try {
        ...
        res.status(201).json({msg: "Registry updated successfully", RegistryData: createRegirsty});
    } catch (err) {
        res.status(500).json({msg: "Internal Server Error"});
    }
}
